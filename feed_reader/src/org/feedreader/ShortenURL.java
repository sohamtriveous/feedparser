...
public class ShortenURL {
	...
	public ShortenURL(String login, String apiKey) {
	...
	public BitlyReply getBitlyReply(String urlToShorten) throws JSONException, IOException {
	...
	private String getBitlyUrl() {
		return "http://api." + ShortenURL.service + "/shorten?version=2.0.1&longUrl=";
	}
